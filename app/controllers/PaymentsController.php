...
class PaymentsController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		$db = $this->GetModel();
		$fields = array('payments.id', 'payments.request_id', 'payments.payer', 'payments.picture', 'payments.status', 'payments.created_at',
		'payment_method','user.firstname','user.lastname','user.email','user.phoneno','pickup_request.item_name','pickup_request.tracking_id','pickup_request.payment_status');
