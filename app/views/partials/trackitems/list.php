      ...
      <div class="container">
        <div class="row">
            <div class="col-lg-9 mx-auto">
              <h1 class="mb-5">Track <br> My Deliveries</h1>
            </div>
        </div>
      </div>
        ...
        <div class="widget">
                    <div class="row ">
                        <div  class="col-sm-4 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Delivery Items</h3>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          ...
                          <li class="list-inline-item"><i class="fa fa-road"></i>{{data.records.distance}} KM</li>
                                ...
                                <ul class="card-meta-tag list-inline" v-if="data.records.pickup_status == 3 && data.records.rate == 0">
                                    <li class="list-inline-item" style="color:red;">Delivered</li>
                                    <li class="list-inline-item" @click="showPopOpenReviewModal(data.records.id)"><a> Rate Delivery <i class="fa fa-star"></i></a></li>
                                </ul>
                                <ul class="card-meta-tag list-inline" v-if="data.records.pickup_status == 3 && data.records.rate != 0">
                                    <li class="list-inline-item" style="color:red;">Delivered</li>
                                    <li class="list-inline-item">
                                      <i v-for="(star, index) in data.records.rate" :key="index"
                                        class="fa fa-star list-inline-item"
          ...
          <div id="openPaymentInfoModal" class="modal fade" role="dialog">
            ...
            <div class="row justify-content-center" v-else>
              <div class="col-sm-12 text-center">
                ...
                <button class="btn btn-primary" @click="confirmPayment(paymentsinfo.request_id)" type="button">Confirm<i class="fa fa-send"></i></button>
              </div>
            </div>
                      </div>
                      <div class="modal-footer">
...
<div class="banner text-center">
      <div class="container">
        <div class="row">
            <div class="col-lg-9 mx-auto">
              <h1 class="mb-5">Delivery <br>Items</h1>
            </div>
        </div>
      </div>
      <svg class="banner-shape-1" width="39" height="40" viewBox="0 0 39 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <section class="section-sm">
      <div class="container">
        <div class="widget">
                    <div class="row ">
                        <div  class="col-sm-4 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Deliveries</h3>
                        </div>
                        <div v-if="searchfield" class="col-sm-4 comp-grid" :class="setGridSize">
                            <input @keyup.enter="dosearch()" v-model="searchtext" class="form-control" type="text" name="search" placeholder="Search" />
                        </div>
                        ...
                        <div class="col-md-12">
                          ...
                          <li class="list-inline-item"><i class="fa fa-road"></i>{{data.records.distance}} KM</li>
                              ...
                              <ul class="card-meta-tag list-inline">
                                ...
                                <li class="list-inline-item" v-if="data.records.pickup_status == 1" @click="startPickup(data.records.id)"><a>Start Journey<i style="color:green;" class="fa fa-motorcycle"></i></a></li>
                                ...
                                <li class="list-inline-item" v-if="data.records.pickup_status == 2" style="color:red;">Pickup In Transit</li>
                                <li class="list-inline-item" v-if="data.records.pickup_status == 2" @click="endPickup(data.records.id)"><a>End Journey<i style="color:green;" class="fa fa-check-square-o"></i></a></li>
