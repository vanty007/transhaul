<template id="riders_availabilityView">
            ...
            <div class="container">
                <div class="row no-gutters justify-content-center">
                    ...
                    <div class="col-md-8 col-lg-6 text-center text-md-left">
                        <h3 class="mb-2">{{data.lastname}} {{data.firstname}}</h2>
                            <strong class="mb-2 d-block"><i class="fa fa-phone" style="font-size:14px;color:#077A07"></i><a :href="'tel: '+ data.phoneno"> {{data.phoneno}}</a></strong>
                            <!--<div class="content">
                            ...
                            <ul class="list-inline social-icons">
                                ...
                                <li class="list-inline-item">
									<i v-for="(star, index) in Math.ceil(data.avg_rate)" :key="index" class="fa fa-star list-inline-item" :style="{color: 'gold',fontSize: '20px' }"></i>
								</li> 
    ...
    <script>
	var Riders_AvailabilityViewComponent = Vue.component('riders_availabilityView', {
		template : '#riders_availabilityView',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'riders_availabilityview',
			},
			apipath: {
				type : String,
				default : 'riders_availability/view',
			},
		},
		data: function() {
			return {
				data : {
					default :{
						id: '',driver_id: '',firstname: '',lastname: '',phoneno: '',avg_rate: '',
					},
				},
			}
		},
		computed: {
			pageTitle: function(){
				return 'View  Riders Availability';
			},
		},
		methods :{
			resetData : function(){
