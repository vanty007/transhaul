                ...
                <div class="row">
                    <div class=" col-lg-8 mb-5 mb-lg-0">
                        ...
                        <div class="widget">
                                ...
                                <article>
                                    <img class="card-img-sm" :src="data.picture || 'assets/images/carts.jpg'" style="justify-content: center;align-items: center;border-radius: 50px;width: 400px;height: 350px;margin: 0 auto;overflow: hidden;object-fit: fill;display: block;margin: auto;">
                                    <div class="card-body">
                                        ...
                                        <li class="list-inline-item">
                                            ...
                                            <a :href="'#riders_availability/view/'+data.driver_id" class="card-meta-author" v-if="data.driver_id != null">
